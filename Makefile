...
APP_SRC_DIR=$(shell pwd)/external/odin2

# base app name
APP_NAME=Odin2

# app build directory name. Usually repo name is good.
APP_BUILD_DIR=apps/odin2

# aap_metadata.xml source
AAP_METADATA_XML_SOURCE=$(shell pwd)/apps/Odin2.aap_metadata.xml

# diff file to app, generated by git diff. "-" if there is no patch.
PATCH_FILE=$(shell pwd)/apps/odin2-aap.patch
